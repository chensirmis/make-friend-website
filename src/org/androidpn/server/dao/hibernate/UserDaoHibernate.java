...
public class UserDaoHibernate extends HibernateDaoSupport implements UserDao {
	...
	public List<User> checkUser(User user) {
		...
		return getHibernateTemplate().find("from User where studentname=? and studentid=? and studentPassword=?",
				new String[]{user.getStudentname(),user.getStudentid(),user.getStudentPassword()});
	}
