...
public class IQRegisterHandler extends IQHandler {
    ...
    public IQRegisterHandler() {
        ...
        probeResponse.addElement("studentid");
        probeResponse.addElement("password");
        probeResponse.addElement("email");
        probeResponse.addElement("studentName");
        probeResponse.addElement("studentPassword");
    }
        ...
        if (IQ.Type.get.equals(packet.getType())) {
            ...
            try {
                ...
                if (query.element("remove") != null) {
                    ...
                    String studentid=query.elementText("studentid");
                    String studentName=query.elementText("studentName");
                    String studentPassword=query.elementText("studentPassword");
                    // Verify the username
                    if (username != null) {
