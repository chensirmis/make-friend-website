...
import org.androidpn.server.xmpp.handler.IQDeleteHandler;
...
public class IQRouter {
    ...
    public IQRouter() {
        ...
        iqHandlers.add(new IQDeleteHandler());
    ...
    public void route(IQ packet) {
        ...
        if (session == null
                ...
                || ("jabber:iq:auth".equals(packet.getChildElement()
                        ...
                        .equals(packet.getChildElement().getNamespaceURI())||"jabber:iq:comfirm".
    ...
    private void handle(IQ packet) {
        try {
            ...
            if (namespace == null) {
                ...
                IQHandler handler = getHandler(namespace);//执行IQRegisterHandler类
                if (handler == null) {
